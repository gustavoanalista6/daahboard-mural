...
class CursoController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $categorias = ['presencial', 'ead'];
        return view('cursos.create')->with('filiais', $filiais)->with('categorias', $categorias);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cursos.edit')->with('curso', $curso)->with('filiais', $filiais)->with('categorias', $categorias);
    }
